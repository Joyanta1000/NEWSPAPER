...
<body>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="post" action="{{URL::to('/update/'.$papers->id)}}" enctype="multipart/form-data">
				{{csrf_field()}}
				...
				<div class="wrap-input100 validate-input bg1" data-validate="Please Type Title">
					...
					<input class="input100" type="text" name="title" placeholder="Enter Title" value="{{$papers->title}}">
				</div>
				...
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate = "Enter Details">
					...
					<input class="input100" type="text" name="details" placeholder="Enter Details " value="{{$papers->details}}">
				</div>

				<div class="wrap-input100 bg1 rs1-wrap-input100" data-validate="Please Enter Date">
					<span class="label-input100">DATE</span>
					<input class="input100" type="date" name="date" placeholder="Enter Date" value="{{$papers->date}}" required>
				</div>
				...
				<div class="wrap-input100 input100-select bg1" data-validate="Please Enter Types">
					...
					<div>
						<select class="js-select2" name="types" required>
							<option value="{{$papers->types}}">{{$papers->types}}</option>
				...
				<div class="wrap-input100 input100-select bg1" data-validate="Please Enter Subtypes">
					<span class="label-input100">SUBTYPES *</span>
					<div>
						<select class="js-select2" name="subtypes" required>
							<option value="{{$papers->subtypes}}">{{$papers->subtypes}}</option>
				...
				<div class="wrap-input100 bg1 rs1-wrap-input100" data-validate="Please Enter File or Image">
					<span class="label-input100">FILE or IMAGE(2)</span>
					*Not Required
					<input class="input100" type="file" name="image1">
				</div>

				<div class= "wrap-input100 bg1 rs1-wrap-input100" >
					<span class="label-input100">DETAILS (2)*</span>
					<input class="input100" type="text" name="details1" placeholder="Enter Details " value="{{$papers->details1}}">
				</div>
				...
				<div class="wrap-input100 bg1 rs1-wrap-input100" data-validate="Please Enter Reporters Name">
					...
					<input class="input100" type="text" name="reporter" placeholder="Reporter" value="{{$papers->reporter}}" required>
				</div>
				...
				<div class="wrap-input100 bg1 rs1-wrap-input100" data-validate="Please Enter Reporters Code">
					...
					<input class="input100" type="text" name="rcode" placeholder="Reporters Code" value="{{$papers->rcode}}" required>
				</div>
				...
				<div class="wrap-input100 bg1 rs1-wrap-input100" data-validate="Please Enter Reporters Email">
					...
					<input class="input100" type="text" name="repemail" placeholder="Reporters Email" value="{{$papers->repemail}}" required>
				</div>


				<div class="wrap-input100 input100-select bg1" data-validate="Please Enter Status">
					<span class="label-input100">STATUS</span>
					<div>
						<select class="js-select2" name="status" required>
							<option value="{{$papers->status}}">{{$papers->status}}</option>
