...
<body>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="post" action="{{URL::to('/store')}}" enctype="multipart/form-data">
				{{csrf_field()}}
				...
				<div class="wrap-input100 bg1 rs1-wrap-input100" data-validate="Please Enter Reporters Code">
					...
					<input class="input100" type="text" name="rcode" placeholder="Reporter" required>
				</div>
				...
				<div class="wrap-input100 bg1 rs1-wrap-input100" data-validate="Please Enter Reporters Email">
					...
					<input class="input100" type="text" name="repemail" placeholder="Reporter" required>
				</div>
